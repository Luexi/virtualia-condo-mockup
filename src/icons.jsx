...
const Map = I([h('path',{key:1,d:'M9 4 3 6.5v13L9 17l6 2.5 6-2.5v-13L15 6.5 9 4z'}),h('path',{key:2,d:'M9 4v13M15 6.5v13'})]);
const Maximize = I([h('path',{key:1,d:'M4 9V5a1 1 0 011-1h4M20 9V5a1 1 0 00-1-1h-4M4 15v4a1 1 0 001 1h4M20 15v4a1 1 0 01-1 1h-4'})]);
