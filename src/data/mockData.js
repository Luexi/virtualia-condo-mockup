...
const UNITS = [
  ...
  { u: "B-806", com: "cedro", tipo: "Departamento", owner: "Propietario 18", tenant: "-", renta: false, saldo: 0, estado: "corriente", dias: 0, contacto: "Contacto privado", cars: 2, tags: ["Comite"], m2: 92 },
...
const STATEMENT = {
  ...
  pagos: [
    ...
    { fecha: "03 Abr 2026", concepto: "Pago manual abril", monto: 2100, metodo: "Deposito reportado", ref: "REC-0074", estado: "validado" },
    { fecha: "06 Mar 2026", concepto: "Pago manual marzo", monto: 2100, metodo: "Efectivo administracion", ref: "REC-0068", estado: "validado" },
  ],
  timeline: [
...
const PAGOS_VALIDAR = [
  ...
  { id: "PV-0090", unit: "Casa 37", com: "lago", monto: 9400, metodo: "Deposito reportado", fecha: "22 Jun 2026 / 08:40", quien: "Residente 11", evidencia: "ficha_deposito_0090.jpg", estado: "nuevo" },
  ...
  { id: "PV-0088", unit: "Casa 58", com: "lago", monto: 2100, metodo: "Efectivo administracion", fecha: "21 Jun 2026 / 16:05", quien: "Propietario 30", evidencia: "recibo_caja_0088.jpg", estado: "nuevo" },
  ...
  { id: "PV-0084", unit: "B-806", com: "cedro", monto: 2100, metodo: "Deposito reportado", fecha: "19 Jun 2026 / 18:44", quien: "Propietario 18", evidencia: "ficha_0084.jpg", estado: "revision" },
...
const TICKETS = [
  { id: "MT-318", titulo: "Fuga en cisterna nivel B", cat: "Plomeria", icon: "Droplet", prio: "alta", resp: "Mtto. interno", prov: "Por asignar", costo: 0, estado: "proceso", com: "cedro", fecha: "22 Jun 2026" },
  { id: "MT-317", titulo: "Falla intermitente elevador 2", cat: "Elevador", icon: "Elevator", prio: "alta", resp: "Administracion", prov: "Por asignar", costo: 0, estado: "programado", com: "cedro", fecha: "21 Jun 2026" },
  ...
  { id: "MT-315", titulo: "Poda de areas verdes acceso", cat: "Jardineria", icon: "Leaf", prio: "baja", resp: "Jardineria", prov: "Por asignar", costo: 0, estado: "programado", com: "lago", fecha: "20 Jun 2026" },
  ...
  { id: "MT-313", titulo: "Camara caseta sin senal", cat: "Seguridad", icon: "Shield", prio: "alta", resp: "Vigilancia", prov: "Por asignar", costo: 0, estado: "nuevo", com: "lago", fecha: "19 Jun 2026" },
  ...
  { id: "MT-311", titulo: "Fuga en jardin casa 37", cat: "Plomeria", icon: "Droplet", prio: "media", resp: "Mtto. externo", prov: "Por asignar", costo: 0, estado: "resuelto", com: "lago", fecha: "17 Jun 2026" },
];

const TICKET_ESTADOS = [
  { k: "nuevo", label: "Nuevo", badge: "slate" },
  { k: "revision", label: "En revision", badge: "sky" },
...
const PREVENTIVO = [
  ...
  { titulo: "Revision elevadores", prox: "02 Jul 2026", com: "Torre Cedro", icon: "Elevator", estado: "Programado" },
  { titulo: "Fumigacion areas comunes", prox: "Por agendar", com: "Ambas", icon: "Leaf", estado: "Por agendar" },
];

const POOLS = [
  { id: "ALB-CC", nombre: "Alberca Casa Club", com: "Privada Lago Azul", estado: "optima", ph: 7.4, cloro: 1.8, alc: 110, ultima: "22 Jun 2026 / revision visual", prox: "28 Jun 2026", prov: "Por asignar", costo: 0, temp: 27 },
  { id: "ALB-N", nombre: "Alberca Norte", com: "Privada Lago Azul", estado: "atencion", ph: 7.9, cloro: 0.6, alc: 95, ultima: "21 Jun 2026 / observacion manual", prox: "Por confirmar", prov: "Por asignar", costo: 0, temp: 26 },
...
const POOL_LOG = [
  { fecha: "22 Jun 2026", accion: "Revision visual de area", quien: "Mtto. interno", ph: 0, cloro: 0, tone: "green" },
  { fecha: "21 Jun 2026", accion: "Limpieza general registrada", quien: "Mtto. interno", ph: 0, cloro: 0, tone: "slate" },
  { fecha: "20 Jun 2026", accion: "Observacion pendiente de atencion", quien: "Administracion", ph: 0, cloro: 0, tone: "amber" },
  { fecha: "19 Jun 2026", accion: "Bitacora actualizada", quien: "Administracion", ph: 0, cloro: 0, tone: "slate" },
];

const AMENITIES = [
  { id: "salon", nombre: "Salon de eventos", icon: "Sofa", com: "Torre Cedro", deposito: 2000, regla: "Max. 50 personas / hasta 23:00" },
  { id: "palapa", nombre: "Palapa", icon: "Sun", com: "Privada Lago Azul", deposito: 800, regla: "Max. 30 personas / hasta 22:00" },
  { id: "gym", nombre: "Gimnasio", icon: "Dumbbell", com: "Torre Cedro", deposito: 0, regla: "Aforo 8 / 05:00-23:00" },
  { id: "cancha", nombre: "Cancha multiple", icon: "Briefcase", com: "Privada Lago Azul", deposito: 0, regla: "Bloques de 1 h" },
  { id: "albercac", nombre: "Alberca comun", icon: "Waves", com: "Privada Lago Azul", deposito: 0, regla: "Aforo 25 / 08:00-20:00" },
];

const RESERVAS = [
  { amenidad: "Salon de eventos", unidad: "A-512", dia: "Sab 27 Jun", hora: "18:00-23:00", estado: "aprobada", deposito: 2000 },
  ...
  { amenidad: "Cancha multiple", unidad: "Casa 71", dia: "Mie 01 Jul", hora: "19:00-20:00", estado: "pendiente", deposito: 0 },
];
...
const COMUNICADOS = [
  ...
  { titulo: "Recordatorio de administracion", seg: "Unidades con saldo", fecha: "19 Jun 2026", leido: 0, total: 14, prioridad: "media", estado: "publicado" },
...
const DOCUMENTOS = [
  ...
  { nombre: "Manual de amenidades", tipo: "Operacion", peso: "320 KB", fecha: "15 Feb 2026", icon: "Briefcase" },
];

const VISITAS = [
  { folio: "ACC-7741", nombre: "Visita familiar", unidad: "A-204", tipo: "Visitante", vence: "22 Jun 2026 / 22:00", placa: "JAL-12-***", estado: "autorizado" },
  { folio: "ACC-7738", nombre: "Paqueteria Central", unidad: "Casa 14", tipo: "Proveedor", vence: "22 Jun 2026 / 14:00", placa: "-", estado: "usado" },
  { folio: "ACC-7735", nombre: "Servicio alberca", unidad: "Areas comunes", tipo: "Proveedor", vence: "22 Jun 2026 / 12:00", placa: "JAL-88-***", estado: "usado" },
  ...
  { folio: "ACC-7725", nombre: "Mensajeria Express", unidad: "B-1102", tipo: "Proveedor", vence: "21 Jun 2026 / 18:00", placa: "-", estado: "cancelado" },
];
...
const BITACORA = [
  ...
  { hora: "09:15", evento: "Acceso denegado", detalle: "Codigo expirado / ACC-7730", tone: "red" },
];
...
const EGRESOS = [
  ...
  { cat: "Jardineria", monto: 16800, pct: 8, color: "#94A3B8" },
  { cat: "Administracion", monto: 10600, pct: 6, color: "#5F6F7A" },
];
...
const PROVEEDORES = [
  ...
  { nombre: "Vigilancia", cat: "Operacion", monto: 52800, pct: 100 },
  { nombre: "Albercas", cat: "Operacion", monto: 12000, pct: 64 },
  { nombre: "Jardineria", cat: "Areas comunes", monto: 9600, pct: 51 },
  { nombre: "Plomeria", cat: "Mantenimiento", monto: 6500, pct: 34 },
];

const MOROSIDAD_ANT = [
  { rango: "1-30 dias", unidades: 6, monto: 14200, color: "amber" },
  { rango: "31-60 dias", unidades: 5, monto: 28600, color: "peach" },
  { rango: "61-90 dias", unidades: 2, monto: 16400, color: "red" },
  { rango: "+90 dias", unidades: 1, monto: 8600, color: "red" },
];
...
const PAGOS_RECIENTES = [
  ...
  { fecha: "21 Jun", unit: "B-806", concepto: "Cuota + extraordinaria", monto: 3600, metodo: "Deposito reportado", estado: "validado" },
  { fecha: "21 Jun", unit: "Casa 71", concepto: "Cuota ordinaria junio", monto: 2100, metodo: "Comprobante manual", estado: "validado" },
  { fecha: "20 Jun", unit: "A-204", concepto: "Abono manual", monto: 2100, metodo: "Efectivo administracion", estado: "validado" },
];

const ACTIVIDAD = [
  { txt: "<b>PV-0088</b> quedo aprobado para Casa 58", time: "22 Jun 2026", icon: "CheckCircle", tone: "green" },
  { txt: "Comprobante por revisar de <b>A-204</b> / $4,200", time: "22 Jun 2026", icon: "Wallet", tone: "amber" },
  { txt: "Ticket <b>MT-318</b> paso a <b>En proceso</b>", time: "21 Jun 2026", icon: "Wrench", tone: "peach" },
  { txt: "Alberca Norte marcada como <b>Requiere atencion</b>", time: "21 Jun 2026", icon: "Waves", tone: "amber" },
