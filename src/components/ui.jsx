...
import { PAGE_META } from "../lib/routes.js";
import { formatCurrencyMXN } from "../lib/formatters.js";
...
function Money({ value, className = '' }) {
  const neg = value < 0;
  return e('span', { className: `money ${neg ? 'money--neg' : ''} ${className}` }, formatCurrencyMXN(value));
}
